...
import com.moviedemo.movieapp.databinding.PopularMoviesRowBinding
import com.moviedemo.movieapp.ui.movie.adapters.MovieAdapter

class PopularConcatAdapter(private val moviesAdapter: MovieAdapter): RecyclerView.Adapter<com.moviedemo.movieapp.core.BaseConcatHolder<*>>() {
    ...
    private inner class ConcatViewHolder(val binding: PopularMoviesRowBinding): com.moviedemo.movieapp.core.BaseConcatHolder<MovieAdapter>(binding.root){
